import { BASE_POSITIONS, HOME_ENTRANCE, HOME_POSITIONS, PLAYERS, SAFE_POSITIONS, START_POSITIONS, STATE, TURNING_POINTS } from './constants4.js';
...
export class Ludo {
    ...
    incrementTurn() {
        ...
        // Passage au joueur suivant (0->1->2->3->0)
