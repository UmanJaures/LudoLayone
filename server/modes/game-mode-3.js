/**
 * Mode de jeu pour 3 joueurs
 */

import { BASE_POSITIONS, HOME_POSITIONS, HOME_ENTRANCE, SAFE_POSITIONS } from '../constants/constants-3.js';

export class GameMode3 {
    static TOTAL_PLAYERS = 3;
    static PLAYERS = ['P1', 'P2', 'P3'];
    ...
    static canCaptureAtPosition(position, capturingPlayer) {
        ...
        // Vérifier toutes les entrées de maison
        ...
        // Vérifier toutes les positions maison
    ...
    static getNextPlayer(currentPlayer, diceValue, hasMoved, activePlayers = null) {
        console.log('GameMode3.getNextPlayer called:', { 
            currentPlayer, 
            diceValue, 
            hasMoved, 
            activePlayers 
