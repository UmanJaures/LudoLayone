...
export class SpectateLudo {
    ...
    handleCaptureAnimation(player, piece, position) {
        ...
        const adversaries = ['P1', 'P2', 'P3'].filter(p => p !== player);
            ...
            for (let i = 0; i < 4; i++) {
                if (this.currentPositions[adversary][i] === position) {
                    ...
                    const basePosition = adversary === 'P1' ? [500, 501, 502, 503] : 
                                         ...
                                         [700, 701, 702, 703]; // ✅ NOUVEAU : Base pour P3
    ...
    handleTurnChange(currentPlayer) {
        ...
        const turnIndex = currentPlayer === 'P1' ? 0 : currentPlayer === 'P2' ? 1 : 2;
